...
That action is what removes the note from Inbox. If auto-advance is enabled in Settings > Workflow, Bigfoot Note opens the next Inbox item immediately after you mark the current note organized.
