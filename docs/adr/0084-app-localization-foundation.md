...
- `ui_language` is an installation-local app setting in `~/.config/com.bigfoot.app/settings.json`; `null` means "follow system language when supported, otherwise English".
